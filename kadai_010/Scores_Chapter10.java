...
public class Scores_Chapter10 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // クエリの実行
            String selectSql = "SELECT * FROM scores ORDER BY score_math DESC, score_english ASC";
            resultSet = statement.executeQuery(selectSql);
            
            System.out.println("数学・英語の点数が高い順に並べかえました");
            ...
            while (resultSet.next()) {
                ...
                System.out.println("生徒id=" + id + " 氏名=" + name + " 数学=" + scoreMath + " 英語=" + scoreEnglish);
            }
